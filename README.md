...
- To see the working of the project, follow this [link]([https://github.com/iamdhrutipatel/DeepFake-Detection/blob/main/Implementation%20Video.mp4](https://github.com/ritikkumar31/AuthentiVision-Detector/blob/main/Implementation%20Video.mp4)).
